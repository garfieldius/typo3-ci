...
.PHONY: default
default: php7.2-node10 php7.2-node12 php7.2-node14 php7.3-node10 php7.3-node12 php7.3-node14 php7.4-node10 php7.4-node14 php7.4-node16 php8.0-node10 php8.0-node14 php8.0-node16 php8.1-node10 php8.1-node14 php8.1-node16
...
.PHONY: php8.1-node10
php8.1-node10:
	@docker buildx build --tag $(IMAGE_TAG):php8.1-node10 --platform linux/amd64,linux/arm64 --progress plain $(BUILD_ARG) ./php8.1-node10/.
...
clean:
	...
	@docker rmi $(IMAGE_TAG):php8.1-node10

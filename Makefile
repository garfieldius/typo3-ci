...
.PHONY: default
default: php7.2-node12 php7.2-node10 php7.3-node12 php7.3-node10 php7.4-node10 php7.4-node14 php8.0-node10 php8.0-node14
...
.PHONY: php8.0-node10
php8.0-node10:
	@docker build --pull -t $(IMAGE_TAG):php8.0-node10 ./php8.0-node10/.
